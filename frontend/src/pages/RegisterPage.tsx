    ...
    <div className="max-w-md mx-auto py-16 px-4 bg-white min-h-[85vh]">
      <div className="p-8 border border-slate-200 rounded-3xl shadow-xl space-y-6 bg-white text-slate-900">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black font-outfit text-slate-900">Create Account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          >
            <UserPlus className="w-4 h-4 text-black" /> {loading ? 'Registering...' : 'Register Firebase Account'}
          </button>
        </form>

        <p className="text-center text-xs text-slate-500 font-medium">
          Already have an account?{' '}
          <Link to="/login" className="text-[#FFBA00] font-black hover:underline">
            Sign In
          </Link>
        </p>
      </div>
